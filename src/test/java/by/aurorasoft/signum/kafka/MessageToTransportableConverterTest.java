package by.aurorasoft.signum.kafka;
...
public final class MessageToTransportableConverterTest {
    ...
    @Test
    public void messageWithNullAsIdShouldBeConvertedToTransportableWithIdEqualsZero() {
        final Message givenMessage = Message.builder()
                .datetime(parse("2007-12-03T10:15:30Z"))
                .coordinate(new GpsCoordinate(4.4F, 5.5F))
                .speed(6)
    ...
    @Test
    public void messageWithNullAsDateTimeShouldBeConvertedToTransportableWithdateTimeEpochSecondEqualsZero() {
        final Message givenMessage = Message.builder()
                .id(255L)
                .coordinate(new GpsCoordinate(4.4F, 5.5F))
                .speed(6)
    ...
    @Test
    public void messageWithNullAsCoordinateShouldBeConvertedToTransportableWithLatitudeAndLongitudeEqualZero() {
        final Message givenMessage = Message.builder()
                .id(255L)
                .datetime(parse("2007-12-03T10:15:30Z"))
                .speed(6)
